    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                Console.WriteLine("(1)id정렬 (2)성적순 정렬 (3)국어점수 정렬 (4)특정점수이상 (5)특정점수이하 (0)나가기");
        ...
        static void FindDataUp(List<CStudent> _listData, bool isUP)
        {
            ...
            {
                Console.Clear();
                Console.WriteLine("입력값 {0}은 잘못된 입력입니다. 숫자만 입력하세요!!", num);
            }
            finally
            {
                if(num < 0)
                {
                    Console.Clear();
                    Console.WriteLine("입력값 {0}은 잘못된 입력입니다. 큰수를 입력하세요!!", num);
                }

                if (num > 300)
                {
                    Console.Clear();
                    Console.WriteLine("입력값 {0}은 잘못된 입력입니다. 작은수를 입력하세요!!", num);
                }
            }
